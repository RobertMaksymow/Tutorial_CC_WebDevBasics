...
function renderInputButtons(labels, groupName) {
  console.log("bug hunt", labels, groupName);
...
function updateResults() {
  ...
  document.getElementById("salarySelected").innerText =
    `The salary for ${role}s at ${company} is \n ${salary}`;
  document.getElementById("salaryAverageByRole").innerText =
    `The industry average salary for ${role} positions is \n ${averageSalaryByRole}`;
  document.getElementById("salaryAverageByCompany").innerText =
    `The average salary at ${company} is \n ${averageSalaryByCompany}`;
  document.getElementById("salaryAverageIndustry").innerText =
